...
{
    public class HttpRouterHandlingContext : IHttpHandlingContext
    {
        public HttpRouterHandlingContext(IHttpHandler controllerHandler, IHttpHandler resourceHandler)
        {
